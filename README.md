...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td align="center"></td>
      <td><a href="https://github.com/marcuwynu23/haribon">haribon</a> — Lightweight, production-ready Layer 7 HTTP load balancer in Go. Simple, observable and extensible — built for frontend and backend web servers.</td>
      <td>v2.0.1</td>
      <td>v2.0.1</td>
